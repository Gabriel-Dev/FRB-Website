...
export const OurDifferential = ()=> {
    return (
        ...
        <Main>
           ...
           <img className="imgCard" src={flexibility} alt="Imagem sobre agilidade" /></div>
           <div className="positionCard"><div className="positionText">
           <p className="purple">Simplicidade</p>
           <p className="article">Tornar o processo de solicitação de seguro de vida simples e sem complicações é um compromisso que levamos a sério. Com formulários de inscrição simplificados e a conveniência de solicitar online, garantimos que você possa obter cobertura de forma rápida e eficiente</p></div>
           <img  className="imgCard" src={simplicity} alt="Imagem sobre agilidade" /></div>
            <div className="positionCard invert">
                <div className="positionText"><p className="purple">Tecnologia</p><p className="article">Possuímos tecnologia de ponta para visualização de dados em Power Bi, onde o cliente tem uma visão totalmente aprofundada do relatório médico de cada empregado de sua empresa.</p></div>
